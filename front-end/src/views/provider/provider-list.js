                    ...
                    <CCol>
                        <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                            <Link to="/providers/create">
                                <CButton color="primary">Nuevo Provedor</CButton>
                            </Link>
            ...
            <CCardBody>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead color="light">
                  <CTableRow>
                    <CTableHeaderCell className="text-center">Compania</CTableHeaderCell>
                    <CTableHeaderCell className="text-center">Contacto</CTableHeaderCell>
